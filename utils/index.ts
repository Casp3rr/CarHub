...
//function
export async function fetchCars(filters: { year: string | number; fuel: string; limit: number; model: string; manufacturer: string }) {
    const { manufacturer, model, year, limit, fuel } = filters;
    const headers = {
		'X-RapidAPI-Key': '070496c10dmshf78a9e2502bc1a3p1caf94jsn567271044ef6',
