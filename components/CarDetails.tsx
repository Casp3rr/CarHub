        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
           ...
           <Transition.Child as={Fragment} 
            ...
            >
                ...
                shadow-xl transition-all flex flex-col text-left gap-5 p-6'>
                    <button type='button'  
                    ...
                    <div className='flex-1 flex flex-col gap-3'>
                        <div className='relative w-full h-40 bg-sky-500 bg-cover bg-center rounded-lg'>
                              <Image
                    ...
                    <div className='flex-1 flex flex-col gap-2'>
                        <h2 className='font-semiboold text-xl capitalize'>
                            {car.make} {car.model}
                        </h2>
